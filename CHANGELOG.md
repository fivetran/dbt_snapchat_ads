...
## Feature update 🎉
- Unioning capability! This adds the ability to union source data from multiple snapchat_ads connectors. Refer to the [README](https://github.com/fivetran/dbt_snapchat_ads/blob/main/README.md) for more details.
